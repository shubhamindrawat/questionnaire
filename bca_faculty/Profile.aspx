<%@ Page Title="" Language="C#" MasterPageFile="~/bca_faculty/faculty.master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="bca_faculty_Profile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form id="form1" runat="server" class="form-horizontal form-label-left">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Faculty Profile <small>Faculty Activity </small></h2>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                        <div class="profile_img">
                            <div id="crop-avatar">
                                ...
                                <asp:Image ID="profile_picture" runat="server" class="img-responsive avatar-view" />
                            </div>
                        </div>
                        <h3>
                            <asp:Label ID="lbl_menu_user" runat="server" Text=""></asp:Label></h3>
