<%@ Page Title="" Language="C#" MasterPageFile="~/bca_faculty/faculty.master" AutoEventWireup="true" CodeFile="Syllabus.aspx.cs" Inherits="Admin_Syllabus" %>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <asp:DropDownList ID="ddl_insert_subject" runat="server" AutoPostBack="True" class="form-control col-md-7 col-xs-12" required="required">
                        </asp:DropDownList>
                      </div>
                </div>
                <div class="form-group">
                ...
                <ContentTemplate>
                    <div class="x_content">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <asp:DropDownList ID="ddl_display_subject" runat="server" AutoPostBack="True" class="form-control col-md-7 col-xs-12" required="required">
                                </asp:DropDownList>
                                </div>
                        </div>
