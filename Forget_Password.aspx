<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Forget_Password.aspx.cs" Inherits="bca_user_Forget_Password" %>
            ...
            <div class="container">
                <div class="row pt60 pb60">
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 login-box">
                        <h4 style="color:#47b475">Forget Password</h4>
                        
                        <div class="form-group">
                                <label for="exampleInputEmail1">Email address</label>
                                 <asp:TextBox ID="txt_user" class="form-control" runat="server" placeholder="Email Address" Required="true"></asp:TextBox>
                            </div>
                        ...
                        <asp:Button ID="Button1" class="st-btn primary-btn hvr-back hvr-sweep-to-right pull-right" runat="server" Text="Submit" OnClick="Button1_Click" />
                       
                           <div class="form-group">
                                    <asp:HyperLink ID="hyper_login" NavigateUrl="Login.aspx" runat="server">Login ?</asp:HyperLink>
                              </div>
