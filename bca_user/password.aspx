<%@ Page Language="C#" AutoEventWireup="true" CodeFile="password.aspx.cs" Inherits="bca_user_password" %>
            ...
            <div class="white-grad">
                  <div class="container">
                    ...
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 login-box">
                        <h4 style="color:#47b475">Enter Exam Password</h4>
                        
                        <div class="form-group">
                                  <asp:TextBox ID="txt_pass" class="form-control" runat="server" placeholder="ENTER THE PASSWORD" TextMode="Password" Required="true"></asp:TextBox>
                            </div>
                        ...
                        <asp:Button ID="Button3" class="st-btn primary-btn hvr-back hvr-sweep-to-right pull-right"  style="text-align:center"    runat="server" Text="Submit" OnClick="Button1_Click" />
